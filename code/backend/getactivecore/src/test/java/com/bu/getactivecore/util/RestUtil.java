...
public class RestUtil {
    ...
    public static ResultActions sendPost(MockMvc mockMvc, RestEndpoint endpoint, Object request) throws Exception {
        return mockMvc.perform(post(endpoint.get())
     ...
     * @throws Exception if an error occurs during request execution
     */
    public static ResultActions sendPost(MockMvc mockMvc, RestEndpoint endpoint, Map<String, String> request, String token) throws Exception {
        return mockMvc.perform(post(endpoint.get())
    ...
    public static ResultActions sendGet(MockMvc mockMvc, RestEndpoint endpoint, Object data) throws Exception {
        return mockMvc.perform(get(endpoint.get())
                .contentType(MediaType.APPLICATION_JSON)
     ...
     * @throws Exception if an error occurs during request execution
     */
    public static ResultActions sendPut(MockMvc mockMvc, RestEndpoint endpoint, Object request, String token) throws Exception {
        return mockMvc.perform(put(endpoint.get())
                .header("Authorization", "Bearer " + token)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)));
    }
